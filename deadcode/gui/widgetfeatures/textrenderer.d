module deadcode.gui.widgetfeatures.textrenderer;

import deadcode.graphics.model;
import deadcode.gui.resources.material : Material;
import deadcode.gui.resources.texture : Texture;
import deadcode.gui.text;
import deadcode.gui.widget;
import deadcode.gui.widgetfeatures : WidgetFeature;
import deadcode.gui.styledtext : TextStyler;
import deadcode.gui.style.stylesheet : Stylable;
import deadcode.gui.textlayout : TextBoxLayout;
import deadcode.gui.event : Event, EventUsed, EventType;
import deadcode.gui.style.stylesheet : matchStylableImpl, StyleSheet;
import deadcode.gui.style.style : Style;
import deadcode.gui.resources.font : Font;
import deadcode.math;
import deadcode.edit.buffer : InvalidIndex;
import core.time;
import std.range;
import std.variant;
import std.conv;
...
//		TextSelectionModel _selectionModel;
	...
	this(Text txt, TextStyler _textStyler = null)
	{
        ...
        import deadcode.gui.models : createQuad;
	...
	{
		// onTextDirty();
		import deadcode.gui.event : GUIEvents;
