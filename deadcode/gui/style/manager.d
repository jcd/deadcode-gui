module deadcode.gui.style.manager;
...
class StyleSheetManager : ResourceManager!StyleSheet
{
	...
	static StyleSheetManager create(FileManager fileManager, MaterialManager mm, FontManager fm)
	{
		import deadcode.gui.resources;
		auto ssm = new StyleSheetManager;
		ssm._materialManager = mm;
		ssm._fontManager = fm;
		ssm.fileManager = fileManager;
		...
		auto ease = deadcode.animation.curve.CubicBezierCurve!float.ease;
